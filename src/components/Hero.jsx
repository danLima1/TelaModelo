...
const Hero = () => {
  ...
  <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]">
    ...
    <span className="text-gradient">Vendas</span>
        ...
        <h1  className="font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full">Neste gateway</h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          aqui havera algo aqui havera algo aqui havera algo aqui havera algo aqui havera algo aqui havera algo
        </p>
      </div>
